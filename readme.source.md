...
<div style={{
  ...
  <div style={{
    ...
    <img src="https://github.com/aki-seven.png" width={88} height={88} style={{ borderRadius: 44 }} />
  </div>
  ...
  <div style={{ display:'flex', flexDirection:'column', marginLeft:168, gap:8, zIndex: 10 }}>
    ...
    <div style={{ display:'flex', fontSize:15, color:'rgba(180,165,255,0.8)', fontWeight:400, letterSpacing:'0.3px' }}>
      A security researcher with wide-focus on ai-related and offensive security skills 
    </div>
    <div style={{ display:'flex', gap:8, marginTop:6, flexWrap: 'wrap' }}>
      {['Security Researcher', 'TCS HQX 100'].map(function(tag, i) {
        return (
          <div key={tag + '-' + i} style={{
